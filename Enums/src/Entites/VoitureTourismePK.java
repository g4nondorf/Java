 ...
 */
@Embeddable
public class VoitureTourismePK implements Serializable {
    ...
    public VoitureTourismePK() {
    }

    public VoitureTourismePK(int numerov, int numeromenage) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof VoitureTourismePK)) {
            return false;
        }
        VoitureTourismePK other = (VoitureTourismePK) object;
    ...
    public String toString() {
        return "Entites.VoitureTourismePK[ numerov=" + numerov + ", numeromenage=" + numeromenage + " ]";
    }
