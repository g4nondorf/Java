...
public class IrisJpaController implements Serializable {
    ...
    public IrisJpaController(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public void create(Iris iris) throws PreexistingEntityException, Exception {
    ...
    public void edit(Iris iris) throws IllegalOrphanException, NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
