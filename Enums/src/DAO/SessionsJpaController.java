...
public class SessionsJpaController implements Serializable {
    ...
    public void create(Sessions sessions) throws PreexistingEntityException, Exception {
    ...
    public void edit(Sessions sessions) throws IllegalOrphanException, NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
