...
public class EtudeJpaController implements Serializable {
    ...
    public EtudeJpaController(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public void create(Etude etude) throws PreexistingEntityException, Exception {
    ...
    public void edit(Etude etude) throws IllegalOrphanException, NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
