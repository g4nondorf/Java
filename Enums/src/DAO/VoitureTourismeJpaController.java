...
public class VoitureTourismeJpaController implements Serializable {
    ...
    public VoitureTourismeJpaController(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public void create(VoitureTourisme voitureTourisme) throws PreexistingEntityException, Exception {
    ...
    public void edit(VoitureTourisme voitureTourisme) throws NonexistentEntityException, Exception {
        voitureTourisme.getVoitureTourismePK().setNumeromenage(voitureTourisme.getMenage().getNumeromenage());
        EntityManager em = null;
        try {
            em = getEntityManager();
    ...
    public void destroy(VoitureTourismePK id) throws NonexistentEntityException {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
