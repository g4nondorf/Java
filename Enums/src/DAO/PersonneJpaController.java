...
public class PersonneJpaController implements Serializable {
    ...
    public void create(Personne personne) throws IllegalOrphanException, PreexistingEntityException, Exception {
    ...
    public void destroy(PersonnePK id) throws NonexistentEntityException {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
