...
public class PanelJpaController implements Serializable {
    ...
    public PanelJpaController(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public void create(Panel panel) throws PreexistingEntityException, Exception {
    ...
    public void edit(Panel panel) throws IllegalOrphanException, NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
    ...
    public void destroy(PanelPK id) throws IllegalOrphanException, NonexistentEntityException {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
