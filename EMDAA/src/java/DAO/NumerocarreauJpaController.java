...
public class NumerocarreauJpaController implements Serializable {
    ...
    public NumerocarreauJpaController(UserTransaction utx, EntityManagerFactory emf) {
        this.utx = utx;
        this.emf = emf;
    }
    ...
    public void create(Numerocarreau numerocarreau) throws PreexistingEntityException, RollbackFailureException, Exception {
    ...
    public void edit(Numerocarreau numerocarreau) throws IllegalOrphanException, NonexistentEntityException, RollbackFailureException, Exception {
        EntityManager em = null;
        try {
            utx.begin();
            em = getEntityManager();
