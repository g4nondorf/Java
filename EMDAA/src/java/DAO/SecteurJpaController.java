...
public class SecteurJpaController implements Serializable {
    ...
    public SecteurJpaController(UserTransaction utx, EntityManagerFactory emf) {
        this.utx = utx;
        this.emf = emf;
    }
    ...
    public void create(Secteur secteur) throws PreexistingEntityException, RollbackFailureException, Exception {
    ...
    public void edit(Secteur secteur) throws IllegalOrphanException, NonexistentEntityException, RollbackFailureException, Exception {
        EntityManager em = null;
        try {
            utx.begin();
            em = getEntityManager();
