 ...
 */
@Embeddable
public class MotoPK implements Serializable {
    ...
    public MotoPK(int numerov, int numeromenage) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MotoPK)) {
            return false;
        }
        MotoPK other = (MotoPK) object;
    ...
    public String toString() {
        return "Entites.MotoPK[ numerov=" + numerov + ", numeromenage=" + numeromenage + " ]";
    }
