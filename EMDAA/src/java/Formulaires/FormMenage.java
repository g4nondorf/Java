...
public class FormMenage {
    ...
    public FormMenage(int numeroM, boolean telephoneFixe, TypeAbonnementTelephoneFixe AboTelephone, boolean internet, Habitat habitat, PossessionHabitat possessionHabitat) {
